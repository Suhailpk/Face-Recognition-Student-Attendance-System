...
class Help:
    def __init__(self,root):
        ...
        #label
        label2_lbl = Label(main_frame,text="For any assitance or contact",font=("times new roman",15,"bold"),bg="white",fg="blue")
        label2_lbl.place(x=0,y=60)

                #label
        label3_lbl = Label(main_frame,text="Please connect with us.",font=("times new roman",15,"bold"),bg="white",fg="blue")
        ...
        #top image
        inside_img = Image.open('collected_imgs/helpdesk-3.jpg')
